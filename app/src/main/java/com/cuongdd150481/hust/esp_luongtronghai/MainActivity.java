...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("Data").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                for(DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                    DataReceive dataReceive = new DataReceive(dataSnapshot.child("Humi").getValue(Float.class), dataSnapshot.child("Temp").getValue(Float.class));
                    Entry entryHumi = new Entry(orderReceiveData, dataReceive.getHumidity());
                    Entry entryTemp = new Entry(orderReceiveData, dataReceive.getTemperature());
        ...
        buttonMeasure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                myRef.child("Period").setValue(listPriod[iPeriod]);
    ...
    private void lineChartInit(){
        ...
        mpLineChart.setNoDataTextColor(Color.YELLOW);
        ...
        xAxis.setValueFormatter(new IAxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                String time = sdf.format(new Date().getTime() + (long)value*1000);
                return time;
            }
        });
        ...
        LegendEntry[] listLegendEntry = new LegendEntry[2];
